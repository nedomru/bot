    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="📊 Показатели", callback_data="usermenu_salary_type_percents"
            ),
            InlineKeyboardButton(
                text="🌟 Общ. процент", callback_data="usermenu_salary_type_sum"
            ),
        ],
...
def salary_user_position():
    buttons = [
        [
            InlineKeyboardButton(
                text="👶🏻 Спец.", callback_data="usermenu_salary_position_specialist"
            ),
            InlineKeyboardButton(
                text="🔥 Ведущий Спец.",
                callback_data="usermenu_salary_position_lead_specialist",
            ),
        ],
        [
            InlineKeyboardButton(
                text="👑 Эксперт", callback_data="usermenu_salary_position_expert"
            ),
        ],
        [
            InlineKeyboardButton(
                text="👨‍💻 РГ", callback_data="usermenu_salary_position_rg"
            ),
        ],
        [
            InlineKeyboardButton(text="🏠 Домой", callback_data="usermenu"),
